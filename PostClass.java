...
public class PostClass extends ArrayAdapter<String> {
     ...
     */
    public PostClass(ArrayList<String> cpName, ArrayList<String> cpAddress, ArrayList<String> cpCondition, Activity context) {
        super(context, R.layout.car_park_info, cpName);
        this.cpName = cpName;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View carParkInfo = layoutInflater.inflate(R.layout.car_park_info, null, true);
        //Find components
        ...
        toggleButton = (ToggleButton) carParkInfo.findViewById(R.id.toggleButton);
